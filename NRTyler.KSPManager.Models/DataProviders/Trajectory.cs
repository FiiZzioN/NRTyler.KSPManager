...
{
	public class Trajectory : INotifyPropertyChanged, IBurn
	{
		#region Constructors
		...
		public Trajectory(decimal apoapsis, decimal periapsis, decimal inclination, string name = "Name Not Set")
		{
			Apoapsis = apoapsis;
			Periapsis = periapsis;
		...
		/// <param name="name">The name of the trajectory.</param>
		public Trajectory(decimal apoapsis, decimal periapsis, decimal inclination, decimal requiredDeltaV, string name = "Name Not Set")
		{
			Apoapsis = apoapsis;
			Periapsis = periapsis;
			Inclination = inclination;
