...
namespace NRTyler.KSPManager.Models.DataCollections
{
	...
	public class PacificationCollection : INotifyPropertyChanged, ICollection<KeyValuePair<string, PacificationOption>>
	{
		/// <summary>
		...
		public IEnumerator<KeyValuePair<string, PacificationOption>> GetEnumerator()
		{
			yield break;
		}
		...
		#region Implementation of ICollection<KeyValuePair<string,PacificationOption>>

		/// <summary>Adds an item to the <see cref="T:System.Collections.Generic.ICollection`1" />.</summary>
		/// <param name="item">The object to add to the <see cref="T:System.Collections.Generic.ICollection`1" />.</param>
		/// <exception cref="T:System.NotSupportedException">The <see cref="T:System.Collections.Generic.ICollection`1" /> is read-only.</exception>
		public void Add(KeyValuePair<string, PacificationOption> item)
		{
		}
		...
		public bool Contains(KeyValuePair<string, PacificationOption> item)
		{
			return false;
		}
		...
		public void CopyTo(KeyValuePair<string, PacificationOption>[] array, int arrayIndex)
		{
		}
		...
		/// <exception cref="T:System.NotSupportedException">The <see cref="T:System.Collections.Generic.ICollection`1" /> is read-only.</exception>
		public bool Remove(KeyValuePair<string, PacificationOption> item)
		{
			return false;
		}
